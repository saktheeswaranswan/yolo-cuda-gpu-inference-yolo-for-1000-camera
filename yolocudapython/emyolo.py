...
ap.add_argument('-c', '--config', 
                help = 'path to yolo config file', default = ' C:\Users\SPRITLE\Music\furnance\furnace_yolo.cfg ')
ap.add_argument('-w', '--weights', 
                help = 'path to yolo pre-trained weights', default = ' C:\Users\SPRITLE\Music\furnance\furnace_cam_1.weights ')
ap.add_argument('-cl', '--classes', 
                help = 'path to text file containing class names', default = ' C:\Users\SPRITLE\Music\furnance\classes.names ')
args = ap.parse_args()
